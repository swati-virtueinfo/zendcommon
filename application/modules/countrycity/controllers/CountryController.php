...
class Countrycity_CountryController extends Zend_Controller_Action
{
	...
	*/	
    public function indexAction()
    {
		...
		// Get list
		$this->view->asHeading = array("lnk_country_name", "lbl_active","lbl_action");
		...
		{
			$amCountryList[$snKey]['is_active'] = "<a href='/".$this->_getParam('module')."/".$this->_getParam('controller')."/changeactive/id/".$asCountry['id']."/status/".$asCountry['is_active']."' title='Edit'><img src="."'"."/images/".(isset($asCountry['is_active']) && $asCountry['is_active'] == 1 ? "active_check.gif" : "deactive_check.gif")."'"."/></a>";
	...
	*/
    public function changeactiveAction()
    {
        if($this->getRequest()->getParam('id') != '') {
			...
			$bResult = Doctrine::getTable('Model_Country')->changeIsActive($amUpdateIsActive);
