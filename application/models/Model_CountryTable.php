...
class Model_CountryTable extends Doctrine_Table
{
	...
	*/
	public function getCountryList($ssSortOn = '', $ssSortBy = '',$ssSearchField = '', $ssSearchKeyword = '', $ssLang = 'en')
	{
		try
		{
	...
	/**
	* For Fetch all country record for fill combo
	* 
	* @author Bhaskar joshi
	* @access public
	* @return array of Country table records 
	*/
	public function getContries($ssLang = 'en')
	{
		try
		{
			$oSelectQuery = Doctrine_Query::create();
